          ...
          <div className="flex justify-between flex-col sm:flex-row w-full mb-4">
            ...
            <div className="flex justify-center items-center">
              <Button
                ...
                onClick={() =>
                  (window.location.href = "https://choperiacolorado.com.br/")
                }
              >
      ...
      <Drawer open={drawerOpen} onOpenChange={setDrawerOpen}>
        <DrawerContent className="border-none bg-[#ae3537]">
          ...
          <div className="flex flex-col items-center justify-center mb-4">
            {/* Quando clicar na imagem dentro do drawer, vai abrir o Dialog */}
            <img
      ...
      <Dialog open={lightboxOpen} onOpenChange={setLightboxOpen}>
        ...
        ">
          <DialogHeader className="px-4 pt-4">
            <DialogTitle className="text-lg text-black">Visualização</DialogTitle>
